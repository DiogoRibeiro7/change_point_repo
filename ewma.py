class EWMA():
    ...
    def __init__(self, r: float = 0.1, L: float = 2.4, burnin: int = 50, mu: float = 0., sigma: float = 1.):
        self.r = r
        self.one_minus_r = 1 - r  # Precompute this constant for efficiency
        self.L = L
        self.burnin = burnin
        self.mu = mu
        self.sigma = sigma
    ...
    def reset(self) -> None:
        """Reset the statistics and state of the algorithm."""
        self._mu = [self.mu]
    ...
    def update_statistics(self, 
        ...
        """
        self.Z.append(self.one_minus_r * self.Z[-1] + self.r * data_new)  # Use precomputed constant
